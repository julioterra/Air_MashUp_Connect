...
public class AMUP_MIDI {
		...
		public final static int volume_filter_A = 		80;		// value sent must be above 65 to select channel
		public final static int volume_filter_B = 		81;		// value sent must be above 65 to select channel
...
//		final static int midi_channel_volume = 			0;		// value sent ranges between 0 and 127
...
//		final static int midi_monitor = 			3;		// value sent must be above 65 to select monitor
//		final static int midi_select_clip = 			7;		// value sent must be above 65 to select clip
//		final static int midi_eq_high	=			9;		// value sent ranges between 0 and 127
//		final static int midi_eq_mid	=			10;		// value sent ranges between 0 and 127	
//		final static int midi_eq_low	=			11;  	// value sent ranges between 0 and 127
